...
module.exports = {
  data: new SlashCommandBuilder()
    .setName("shuffle")
    .setDescription("Randomizes the current order of tracks in the queue."),
  ...
  run: async (client, interaction) => {
    ...
    if (
      ...
      await [
        ...
        if (!newSongs.includes(songs[number])) newSongs.push(songs[number]);
      });
      await setTimeout(() => {
        songs = newSongs;
        interaction.editReply({
            content: replys.doneOfShuffle,
        })
      }, 1987);
    } else
      return interaction.followUp({
