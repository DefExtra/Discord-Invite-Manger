          ...
          .then((messageOne) => {
            ...
            collector.on("collect", (i) => {
              ...
              i.channel?.messages.fetch(i.message.id).then((m) => {
                m.edit({
                  content: "👀 | please type the leaves channel name/id:",
                  components: [],
                }).then((messageTwo) => {
                        ...
                        m.edit({
                          ...
                          collector.on("collect", (m) => {
                            ...
                            m.channel.messages
                              ...
                              .then((m) => {
                                m.edit({
                                  content: "the leaves config has been set as:",
                                  embeds: [
                                    new MessageEmbed()
                                      .setColor(0x00e8ff)
                                      .addFields(
                                ...
                                db.set(`Leave_${msg?.guildId}`, newLeavesData);
                              });
                          });
                        });
                      }
